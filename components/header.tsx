...
import { Bell, WalletCards, LogOut, User as UserIcon, LogIn } from 'lucide-react'
      ...
      <div className="flex items-center gap-3">
        ...
        {isAuth ? (
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-11 z-50 w-56 rounded-xl border border-border bg-popover p-2 shadow-lg animate-in fade-in duration-150">
          ...
          <Link
            href="/login"
            className="flex items-center gap-2 rounded-xl bg-primary px-3.5 py-1.5 text-xs font-medium text-primary-foreground transition-all hover:opacity-90"
          >
